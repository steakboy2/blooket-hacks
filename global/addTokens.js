                ...
                getValues().then(async e => {
                    fetch("https://api.blooket.com/api/users/add-rewards", {
                        ...
                        body: await encodeValues({
                            name: x.name,
                            addedTokens: ,
                            addedXp: 300
                        }, e.secret)
                    });
                    fetch("https://api.blooket.com/api/users/add-rewards", {
                        ...
                        body: await encodeValues({
                            name: x.name,
                            addedTokens: ,
                            addedXp: 300
                        }, e.secret)
